    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post('/users/signup', {
            name: name,
            email: email,
            password: password,
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _axios.default.get('/users/logout', {
            baseURL: '/api/v1'
          });
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return _axios.default.patch("/users/".concat(url), data, {
            baseURL: '/api/v1',
            withCredentials: true
          });
        ...
        case 4:
          ...
          if (type === 'data') window.setTimeout(function () {
            location.assign('/me');
          }, 1500);
...
exports.stripe = exports.bookTour = void 0;
...
var stripe = Stripe('pk_test_51NWgvMGQU9oQvjcelQgizdr5inMpzFxWtCACc8CJ0uw0aI3QCdM2DBlDfZ3lVYDEmJJfgF8z3UPpnFSECKxpkTAQ00QmIeTOuY');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.get("/bookings/checkout-session/".concat(tourId), {
            baseURL: '/api/v1',
            withCredentials: true
          });
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showAlert)('error', _context.t0.response.data.message || 'Something went wrong! Please try again later.');
...
function () {
  ...
  _regeneratorRuntime().mark(function _callee(e) {
    var passwordCurrent, password, passwordConfirm, success;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          e.preventDefault();
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10006" + '/');
